STATIC_DEFAULT_CONFIG = """
{
  "basic": {
    ...
    "location_recognition_list": [
      {
        "name_list": [["选项", "游戏", "图像", "音量"]],
        "count_list": [[1, 1, 1, 1]],
        "result": "option"
      },
      {
      ...
      },
      {
        "name_list": [["概率信息", "概率"]],
        "count_list": [[1, 3]],
        "result": "probability_message"
      },
      {
        "name_list": [["确认", "返回大厅"]],
        "count_list": [[1, 1]],
        "result": "fight_success"
      },
      {
        "name_list": [["概要", "确认"]],
        "count_list": [[1, 1]],
      ...
      {
        "name_list": [["通知","挑战次数不足"],["通知","入场券不足"]],
        "count_list": [[1,1],[1,1]],
        "result": "charge_notice"
      },
      {
        "name_list": [["通知"]],
        "count_list": [[1]],
...
DEFAULT_CONFIG = """
{
    ...
    "Emulator": {
        "Path": "D:/leidian/LDPlayer9/dnplayer.exe"
    },
    "Settings": {
        "port": "",
        "server": "B服"
