...
def init_args():
    ...
    parser.add_argument("--det_model_dir", type=str, default='src/ocr_models/Multilingual_PP-OCRv3_det_slim_infer')
    ...
    parser.add_argument("--rec_model_dir", type=str, default='src/ocr_models/japan_PP-OCRv3_rec_infer')
