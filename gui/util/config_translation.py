...
class ConfigTranslation(QObject):
    ...
    def __init__(self, parent=None):
        ...
        self.entries = {
            ...
            self.tr('高级经验珠'): '高级经验珠',
            self.tr('特级经验珠'): '特级经验珠',
            self.tr('强化珠礼包A'): '强化珠礼包A',
            self.tr('强化珠礼包B'): '强化珠礼包B',
            self.tr('强化珠礼包C'): '强化珠礼包C',
            self.tr('强化珠礼包D'): '强化珠礼包D',
            self.tr('一包强化珠α'): '一包强化珠α',
            self.tr('一包强化珠β'): '一包强化珠β',
            self.tr('一包强化珠γ'): '一包强化珠γ',
            self.tr('一包强化珠δ'): '一包强化珠δ',
