...
except Exception:  # noqa: BLE001 - Android service uses multipart OCR payloads.
    class SharedMemory:
        @staticmethod
        def get(_name):
            return None
        ...
        @staticmethod
        def set_data(*_args, **_kwargs):
            raise SharedMemoryError("shared memory is not available in Android service runtime")
