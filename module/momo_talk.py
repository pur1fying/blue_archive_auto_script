    ...
    while 1:
        ...
        if length == 0:
            if main_to_momotalk:
                ...
                self.common_positional_bug_detect_method("momo_talk2", 1236, 39, times=7, any=True,
                                                         path="src/momo_talk/momo_talk2.png", name="momo_talk2")
            ...
            for i in range(0, len(unread_location)):
                ...
                time.sleep(2)
                if not self.common_positional_bug_detect_method("momo_talk2", 664, 114, times=2, any=True,
                                                                path="src/momo_talk/momo_talk2.png", name="momo_talk2"):
                    return False
