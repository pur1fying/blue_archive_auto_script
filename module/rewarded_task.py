...
def to_bounty(self, num, skip_first_screenshot=False):
    ...
    rgb_possibles = {
        "main_page": (1198, 580),
        "campaign": (746, choose_bounty_location_y[self.server]),
        "choose_bounty": (992, bounty_location_y[self.server][num]),
        "reward_acquired": (640, 116),
        "purchase_bounty_ticket": (920, 167),
        "mission_info": (task_info_cross_x[self.server], 142),
