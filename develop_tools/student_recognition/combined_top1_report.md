...
|---|---:|---|---|---:|---:|
| MuMu-20260731-235301-451.png | 7-1 | Kotori (Cheer Squad) | Yoshimi (Band) | 0.600 | 0.060 |
| MuMu-20260731-235521-485.png | 1-1 | Mimori (Swimsuit) | Mimori | 0.774 | 0.130 |
| MuMu-20260731-235327-036.png | 1-2 | Kirino (Swimsuit) | Kirino | 0.757 | 0.217 |
| MuMu-20260731-235327-036.png | 4-1 | Michiru | Iori | 0.628 | 0.032 |
| MuMu-20260731-235327-036.png | 7-1 | Mimori (Swimsuit) | Mimori | 0.811 | 0.261 |
| MuMu-20260731-235327-036.png | 8-2 | Marina | Toki | 0.548 | 0.026 |
| MuMu-20260801-074754-624.png | 7-2 | Kotori (Cheer Squad) | Yoshimi (Band) | 0.595 | 0.067 |
| MuMu-20260801-074754-624.png | 8-2 | Neru | Neru (School) | 0.761 | 0.113 |
...
| MuMu-20260731-235327-036.png | 1-2 | Kirino (Swimsuit) | 粉 | 粉 | None |
| MuMu-20260731-235327-036.png | 4-1 | Michiru | 粉 | 粉 | None |
...
`Ako (Dress)`, `Aru`, `Asuna (Bunny)`, `Asuna (School)`, `Ayane`, `Cherino`, `Chinatsu`, `Chinatsu (Hot Spring)`, `Chise`, `Fuuka (New Year)`, `Hanae`, `Hanae (Christmas)`, `Hanako`, `Haruna (New Year)`, `Hibiki`, `Hibiki (Cheer Squad)`, `Hifumi`, `Ibuki`, `Ichika`, `Iori`, `Izumi (Swimsuit)`, `Izuna (Swimsuit)`, `Junko (New Year)`, `Karin (School)`, `Kayoko (New Year)`, `Kirino`, `Kotama`, `Kotama (Camp)`, `Koyuki`, `Maki`, `Mari (Track)`, `Mashiro (Swimsuit)`, `Midori`, `Mika`, `Mimori`, `Miyako`, `Miyu`, `Nagisa`, `Neru (School)`, `Noa`, `Nonomi`, `Nozomi`, `Pina`, `Sakurako`, `Sakurako (Pop Idol)`, `Saten Ruiko`, `Shiroko`, `Shiroko (Cycling)`, `Shokuhou Misaki`, `Shun (Small)`, `Sumire`, `Tsubaki`, `Ui`, `Yuuka`, `Yuzu`, `Yuzu (Maid)`
