stage_data = {
    '2-1-sss-present': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (805, 349), 'wait-over': True, 'desc': "right"},
            {'t': 'click', 'p': (639, 320), 'desc': "upper left"},
        ]
    },
    '2-1-task': {
        'start': [
        ...
        'action': [
            {'t': 'click', 'p': (633, 427), 'wait-over': True, 'desc': "right"},
            {'t': 'click', 'p': (693, 341), 'wait-over': True, 'desc': "upper right"},
            {'t': 'click', 'p': (744, 261), 'desc': "upper right"},
        ]
    },
    '2-2-sss-present': {
        'start': [
    ...
    '2-3-task': {
        ...
        'action': [
            {'t': 'click', 'p': (619, 389), 'wait-over': True, 'desc': "right"},
            {'t': 'click', 'p': (734, 454), 'wait-over': True, 'desc': "right"},
            {'t': 'click', 'p': (720, 350), 'desc': "upper right"},
        ]
    },
}
