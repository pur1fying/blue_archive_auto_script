stage_data = {
    '13-1-sss-present-task': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (457, 425), 'desc': "change 1 2"},
            ...
            {'t': 'exchange', 'ec': True, 'desc': "change to 2"},
            {'t': 'click', 'p': (885, 340), 'wait-over': True, 'desc': "2 right"},
    ...
    '13-2-sss-present': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (490, 345), 'desc': "change 1 2"},
    ...
    '13-3-sss-present-task': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (575, 445), 'desc': "change 1 2"},
            ...
            {'t': 'exchange', 'ec': True, 'desc': "change to 2"},
            {'t': 'click', 'p': (840, 435), 'wait-over': True, 'desc': "2 lower right"},
