stage_data = {
    '5-1-sss-present-task': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (802, 480), 'wait-over': True, 'desc': "right"},
            {'t': 'click', 'p': (784, 369), 'desc': "upper right"},
        ]
    },
    '5-2-sss-present-task': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (779, 479), 'wait-over': True, 'desc': "right"},
            {'t': 'click', 'p': (737, 330), 'desc': "upper right"},
        ]
    },
    '5-3-sss-present': {
        'start': [
        ...
        'action': [
            ...
            {'t': 'click', 'p': (682, 504), 'wait-over': True, 'desc': "lower right"},
            {'t': 'click', 'p': (794, 495), 'wait-over': True, 'desc': "right"},
            {'t': 'click', 'p': (700, 540), 'desc': "lower right"},
        ]
    },
    '5-3-task': {
        'start': [
        ...
        'action': [
            ...
            {'t': 'click', 'p': (619, 414), 'wait-over': True, 'desc': "right"},
            {'t': 'click', 'p': (682, 504), 'wait-over': True, 'desc': "lower right"},
            {'t': 'click', 'p': (739, 580), 'desc': "lower right"},
        ]
    },
}
