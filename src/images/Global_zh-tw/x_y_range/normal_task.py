...
path = "normal_task"
x_y_range = {
    'charge-challenge-counts': (477, 348, 601, 381),
    'fight-confirm': (1120, 646, 1222, 681),
    'prize-confirm': (742, 643, 806, 675),
    'task-info': (578, 90, 702, 153),
    'help': (597, 111, 675, 150),
    'end-turn': (491, 299, 780, 369),
    "fail-confirm": (600, 637, 680, 676),
    'teleport-notice': (532, 317, 639, 351),
    'task-begin-without-further-editing-notice': (494, 295, 787, 375),
    'mission-pause': (566, 142, 710, 182),
    'fight-skip': (1101, 535, 1127, 556),
    'auto-over': (1045, 591, 1067, 609),
    ...
    "sweep-complete": (590, 561, 690, 604),
    "task-finish": (997, 648, 1063, 678),
    ...
    'formation-preset': (598, 79, 718, 129),
    'formation-edit-preset-name': (1184, 219, 1211, 252),
    'formation-set-confirm': (580, 79, 700, 125),
