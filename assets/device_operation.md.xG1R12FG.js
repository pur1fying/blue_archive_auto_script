import{_ as a,o as s,c as e,R as n}from"./chunks/framework.OPRPu5cH.js";const q=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"device_operation.md","filePath":"device_operation.md","lastUpdated":1708082851000}'),t={name:"device_operation.md"},o=n(`<h2 id="使用方法" tabindex="-1">使用方法： <a class="header-anchor" href="#使用方法" aria-label="Permalink to &quot;使用方法：&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">import device_operation</span></span>
